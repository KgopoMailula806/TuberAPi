...
namespace TuberAPI.Controllers
{
    ...
    public class ModulesController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet("[action]/{id}")]
        public IActionResult GetClientModulesByUserTableID_Mobile(int id)
        {
            //Get the Clients Id with the give user table Id 
            var clientTableID = (from C in dbContext.Clients
                                 where C.User_Table_Reference.Equals(id)
        ...
        /// <returns></returns>
        [HttpGet("[action]/{id}")]
        public IActionResult GetTutorModulesByUserTableID_Mobile(int id)
        {
            //Get the Clients Id with the give user table Id 
            var tutorTableID = (from C in dbContext.Tutors
                                where C.User_Table_Reference.Equals(id)
        ...
        [HttpGet("[action]/{id}")]
        public IActionResult getModuleNameByModuleID(int id)
        {
            var cMods = (from m in dbContext.Modules
                         where m.Id.Equals(id)
                         select m.Module_Name).FirstOrDefault();
