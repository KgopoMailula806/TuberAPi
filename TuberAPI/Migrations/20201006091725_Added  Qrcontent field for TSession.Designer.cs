...
namespace TuberAPI.Migrations
{
    ...
    [Migration("20201006091725_Added  Qrcontent field for TSession")]
    partial class AddedQrcontentfieldforTSession
    {
            ...
            modelBuilder.Entity("TuberAPI.models.Rating", b =>
                {
                    ...
                    b.Property<double>("Client_Rating")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("Tutor_Rating")
                        .HasColumnType("float");
